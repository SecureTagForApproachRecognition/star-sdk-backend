...
\hline
 ...
 &  \seqsplit{TBD} \\
\hline
 \ubheader{ method }  & \hyperref[sec:AuthDataMethod]{ AuthDataMethod }   & Specify the method, which should be used to verify data. Probably unused since, if multiple different methods used, we could trace back from which health institute the result came from.
 &  \seqsplit{TBD} \\
\hline
